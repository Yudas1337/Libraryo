        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">Halaman Member</h1>
                </div>
            </div>
        </div>
        @if (session('status'))
                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $a->alamat }}</td>
                            <td>
                                <form method="POST" action="{{ url('admin/member/'.$a->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ url("admin/member/".$a->id) }}" class="btn btn-primary btn-sm"><i class="tio-visible"></i> Detail</a>
                                    <button onclick="return confirm('Apa yakin akan menonaktifkan member?')" type="submit" class="btn btn-danger btn-sm"><i class="tio-delete"></i> Nonaktifkan</button>
                                </form>
                            </td>
                        </tr>
