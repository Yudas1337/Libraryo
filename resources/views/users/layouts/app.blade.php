                ...
                <div class="navbar-nav-wrap-content-right">
                 ...
                 "type": "css-animation"
                                ...
                                <div id="accountNavbarDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-account" style="width: 16rem;">
                                    ...
                                    <a class="dropdown-item" href="{{ asset('users/updatePassword') }}">
            ...
            <div class="navbar-vertical-container">
                <div class="navbar-vertical-footer-offset">
                    <div class="navbar-brand-wrapper justify-content-center" style="height: auto;">
                        ...
                        <a class="navbar-brand" href="{{ url('users/') }}" aria-label="Front">
                    ...
                    <div class="navbar-vertical-content">
                        <ul class="navbar-nav navbar-nav-lg nav-tabs">
                            <!-- Dashboards -->
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::is('users')) ? 'active' : '' }}"  href="{{ url('users') }}" title="Dashboards">
                                    <i class="tio-home-vs-1-outlined nav-icon"></i>
                                    <span class="nav-compact-title text-truncate">Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <small class="nav-subtitle" title="Menu Transaksi">Menu Utama</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ (Request::is('users/peminjaman') || Request::is('users/peminjaman/*')) ? 'active' : '' }} " href="{{ url('users/peminjaman') }}" title="Data Peminjaman">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::is('users/pengembalian') || Request::is('users/pengembalian/*')) ? 'active' : '' }} " href="{{ url('users/pengembalian') }}" title="Data Pengembalian">
                                    <i class="tio-history nav-icon"></i>
                                    <span class="text-truncate">Data Pengembalian</span>
                                </a>
                            </li>
                        </ul>
                    </div>
