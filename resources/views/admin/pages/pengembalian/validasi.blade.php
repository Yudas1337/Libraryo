                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                    @csrf
                                    <input type="text" name="nota" value="{{ $a->nota }}" autocomplete="off" class="form-control" hidden> 
                            <button onclick="return confirm('apakah anda yakin ingin mengvalidasi pengembalian?')" type="submit" class="btn btn-success"><i class="tio-checkmark-circle"></i> Validasi Pengembalian</button>
