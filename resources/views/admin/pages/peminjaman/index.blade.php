        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">Halaman Peminjaman</h1>
                </div>
                <div class="col-sm-auto">
                    <a class="btn btn-danger" href="<?= url('admin/peminjaman/history') ?>">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" autocomplete="off" class="form-control" placeholder="Cari Peminjaman  ">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ count($a->detail) }} Buku</td>
                            <td>{{ date('d M Y H:i:s',strtotime($a->tanggal_pinjam)) }}</td>
                            <td>{{ date('d M Y H:i:s',strtotime($a->tanggal_kembali)) }}</td>
                            <td>
                                    <a target="_blank" href="{{ url("admin/peminjaman/detailPinjam/".$a->nota) }}" class="btn btn-success btn-sm"><i class="tio-visible"></i>Lihat Detail Peminjaman</a>
                            </td>
                        </tr>
